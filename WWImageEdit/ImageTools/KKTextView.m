...
//        _label.textAlignment = NSTextAlignmentCenter;
        ...
        self.frame = CGRectMake(0, 10, _label.frame.size.width + 32, _label.frame.size.height + 32);
...
- (void)setLableFrameWithText:(NSString *)text{
    CGSize constraint = CGSizeMake(_tool.editor.imageView.frame.size.width - 40,0); //这里320是指lable的宽度，下同
    ...
    _label.frame = CGRectMake(16, 16, _tool.editor.imageView.frame.size.width - 40, size.size.height);
