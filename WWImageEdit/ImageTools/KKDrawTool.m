...
- (UIImage*)widthSliderBackground
{
    ...
    UIColor *color = [[[KKImageEditorTheme theme] toolbarTextColor] colorWithAlphaComponent:0.5];
...
- (void)setMenu
{
    ...
    _strokePreview.layer.borderColor = [[[KKImageEditorTheme theme] toolbarTextColor] CGColor];
...
- (void)strokePreviewDidTap:(UITapGestureRecognizer*)sender
{
    ...
    if(_eraserIcon.hidden){
        ...
        _strokePreview.backgroundColor = [[KKImageEditorTheme theme] toolbarTextColor];
        _strokePreviewBackground.backgroundColor = _strokePreview.backgroundColor;
    }
}
